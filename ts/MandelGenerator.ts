let MandelGenerator = (() => {
    ...
    */
    ...
    function gpuRender(canvas: HTMLCanvasElement, oPlaneDef: PlaneDefinition) : Promise<Object> {
        ...
        function cpuRender(canvas: HTMLCanvasElement, oPlaneDef: PlaneDefinition): Promise<Object> {
